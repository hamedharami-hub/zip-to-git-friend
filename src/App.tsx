        ...
        <SettingsBootstrap>
          ...
          >
            ...
            <Routes>
              ...
              <Route path="/sentence-lab/general" element={wrap('SentenceGeneral', <SentenceGeneral />)} />
              <Route path="/sentence-lab/domain/:domain" element={wrap('SentenceDomain', <SentenceDomain />)} />
              <Route path="/sentence-lab/path/:pathId" element={wrap('SentencePathDetail', <SentencePathDetail />)} />
              <Route path="/sentence-lab/path/:pathId/drill" element={wrap('SentenceDrill', <SentenceDrill />)} />
              <Route path="/sentence-lab/planner" element={wrap('SentencePlanner', <SentencePlanner />)} />
              <Route path="/sentence-lab/leitner" element={wrap('SentenceLeitner', <SentenceLeitner />)} />
              <Route path="/sentence-lab/admin" element={wrap('SentenceAdmin', <SentenceAdmin />)} />
              <Route path="/sentence-lab/:categorySlug" element={wrap('SentenceCategory', <SentenceCategory />)} />
              <Route path="/sentence-lab/:categorySlug/:subSlug" element={wrap('SentencePath', <SentencePath />)} />
              <Route path="/sentence-lab/:categorySlug/:subSlug/scenario" element={wrap('SentenceScenario', <SentenceScenario />)} />
              <Route path="/sentence-lab/:categorySlug/:subSlug/:level" element={wrap('SentenceDrill', <SentenceDrill />)} />
              <Route path="/news/article/:articleId" element={wrap('NewsArticle', <NewsArticle />)} />
