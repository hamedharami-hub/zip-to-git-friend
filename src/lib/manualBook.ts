...
export function pastedTextToChapter(raw: string): { html: string; text: string; wordCount: number } {
...
export async function imageFileToDataUrl(file: File, maxBytes = 256 * 1024): Promise<string | null> {
