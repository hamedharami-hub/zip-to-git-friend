...
import { Volume2, ExternalLink, Plus, Loader2, Check, Languages, GraduationCap, EyeOff } from 'lucide-react';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
          ...
          <div className="space-y-2">
            ...
            >
              {loading ? (
                ...
                <span className="text-xs text-muted-foreground">Offline — cannot translate now.</span>
              ) : (
