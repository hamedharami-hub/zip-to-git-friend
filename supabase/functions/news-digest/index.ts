...
const LONG_INSTRUCTIONS =
  "Write a LONG first-person feature of ~900–1300 words. Follow the article-shape rules in the system prompt: bold # title, italic TL;DR, 2-paragraph lede, then 4–6 thematic H2 sections (each 2–3 substantial paragraphs), and a closing ## Where I Land section. Clear B1–B2 English, dense conceptual prose, no bullets.";

const MAX_INSTRUCTIONS =
  "Write a MAXIMUM-LENGTH first-person feature of ~1800–2600 words covering every distinct point in the sources. Follow the article-shape rules: bold # title, italic TL;DR, 2–3 paragraph lede, 6–9 thematic H2 sections (each a deep dive of 2–4 paragraphs of 5–8 sentences), occasional ### sub-headings where a section has natural sub-points, and a closing ## Where I Land section. Strong narrative flow, fully first-person, clear B1–B2 English, no bullet lists.";

const AUTO_MAX_INSTRUCTIONS =
  "Write the LONGEST possible first-person magazine feature the source material can support, aiming for ~2400–4000 words. Cover every detail, sub-point, example, number and quote present in the sources. Do NOT trim. Only stop earlier if the source genuinely doesn't have that much information. Follow the article-shape rules: bold # title, italic TL;DR, 3-paragraph lede that frames the central question, 7–12 thematic H2 sections each with 3–5 paragraphs of 5–8 sentences, ### sub-headings inside sections wherever there's a natural sub-point, and a closing ## Where I Land section of 2–3 paragraphs. Use clear B1–B2 English — short sentences, common vocabulary, no rare or literary words. Make the piece feel CATEGORISED and CONCEPTUAL: each H2 introduces a distinct theme; ideas build context → mechanism → implication → example. Pure prose. Fully first-person. No bullet lists. No 'the author says' framings. No filler.";
