...
const SIMPLE_INSTRUCTIONS_A2 =
  ...
  "CRITICAL — DO NOT SUMMARISE OR SHORTEN. Preserve EVERY fact, name, number, date, place, quote, example, statistic and idea from the source, in the SAME order. The output must be at least as long as the source (≥ 95% of source word count). If a sentence has 3 facts, your rewrite must still contain all 3 facts. " +
...
const SIMPLE_INSTRUCTIONS_B2 =
  ...
  "CRITICAL — DO NOT SUMMARISE OR SHORTEN. Preserve EVERY fact, name, number, date, place, quote, example and idea, in the SAME order. Output length ≥ source length (≥ 95% of source word count). Nothing is allowed to drop. " +
